...
//await context.Technicians.AddAsync(new() { Name = "Pinar", Surname = "Aliogullari", Branch = "Yazılım", Department = "Yazılım Departmanı" });
//await context.Technicians.AddAsync(new() { Name = "Emre", Surname = "Kaya", Branch = "Yazılım", Department = "Yazılım Departmanı" });
//await context.Technicians.AddAsync(new() { Name = "Ufuk", Surname = "Aliogullari", Branch = "Yazılım", Department = "Yazılım Departmanı" });
