...
//Employee e1 = new() { Name = "Pinar", Surname = "Aliogullari", Department = "Yazılım Bilgi İşlem" };
//Employee e2 = new() { Name = "Emre", Surname = "Kaya", Department = "Donanım Tasarım" };
//Customer c1 = new() { Name = "Serkan", Surname = "Aliogullari", CompanyName = "German Akademie" };
//Customer c2 = new() { Name = "Ufuk", Surname = "Aliogullari", CompanyName = "Remscheid Restaurant" };
//Technician t1 = new() { Name = "Nuran", Surname = "Aliogullari", Department = "Muhasebe", Branch = "Şöför" };
...
//var employees = await context.Employees.ToListAsync(); //employele lar ve technicianların tümü gelir.
//var techs = await context.Technicians.ToListAsync(); //sadece technicianlar gelir.
